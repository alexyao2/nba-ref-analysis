...
Note: These metrics are exploratory and should be interpreted cautiously. The conclusions drawn from the data is purely objective and are used to highlight unusual patterns or trends, but they do not independently prove intent, bias, or causation.